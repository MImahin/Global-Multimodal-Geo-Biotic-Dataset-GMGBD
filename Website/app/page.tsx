      ...
      <section id="overview" className="relative min-h-[75vh] flex items-center justify-center px-4 overflow-hidden">
        <div className="relative z-10 max-w-5xl mx-auto text-center pt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="https://drive.google.com/drive/folders/1pebye8kjIpsRZ9OVfoqGwK1kh1dH2wSH" target="_blank" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-primary text-primary-foreground font-bold hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95">Download Dataset (9k Records)</a>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-primary/40 transition-all">
              ...
              <h3 className="font-bold mb-2">BLIP-Large VLM</h3>
            ...
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-primary/40 transition-all">
              ...
              <h3 className="font-bold mb-2">Google Earth Engine</h3>
            ...
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-primary/40 transition-all">
              ...
              <h3 className="font-bold mb-2">SafeRequest Watchdog</h3>
            ...
            <div className="bg-card border border-border p-8 rounded-2xl hover:border-primary/40 transition-all">
              ...
              <h3 className="font-bold mb-2">Open-Meteo Integration</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            <div className="lg:col-span-1">
              ...
              <div className="p-6 bg-primary/5 rounded-2xl border border-primary/20">
                ...
                <p className="text-xs mt-4 italic">"Metadata helps resolve visually similar species that occupy distinct climatic niches."</p>
              </div>
            </div>
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-secondary/20 font-bold">
                <tr>
                  ...
                  <th className="px-6 py-4">Landscape Interpretation</th>
                </tr>
              </thead>
              <tbody>
                {ndviLogic.map((n, i) => (
                ...
                {visualizations.filter(v => v.category === category).map((vis) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <h4 className="font-bold group-hover:text-primary transition-colors">{vis.title}</h4>
          ...
          <div className="bg-card border border-border rounded-3xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-auto bg-muted/20 p-4">
              {selectedVisualization.type === 'html' ? (
                <iframe src={selectedVisualization.src} className="w-full h-[60vh] bg-white rounded-xl shadow-lg border-0" />
              ) : (
      ...
      <footer className="py-24 border-t border-border bg-secondary/10">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-sm opacity-60 leading-relaxed">A high-resolution multimodal benchmark for global wildlife and environmental reanalysis.</p>
          </div>
          <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3 lg:text-right">
            ...
            <a href="https://github.com/MImahin" target="_blank" className="text-sm hover:text-primary transition-colors flex items-center lg:justify-end gap-2">Source Code <Github className="w-4 h-4" /></a>
            <a href="https://drive.google.com/drive/folders/1pebye8kjIpsRZ9OVfoqGwK1kh1dH2wSH" target="_blank" className="text-sm hover:text-primary transition-colors flex items-center lg:justify-end gap-2">Raw Dataset <Database className="w-4 h-4" /></a>
          </div>
        </div>
      </footer>
    </div>
